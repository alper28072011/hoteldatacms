        ...
        <div className="flex flex-col h-full bg-slate-50/50">
            ...
            <div className="flex-1 overflow-y-auto p-8">
                <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-xl min-h-[800px] p-12 print:shadow-none print:p-0" ref={componentRef}>
                    ...
                    {/* Footer for Print */}
                    <div className="hidden print:block fixed bottom-4 left-0 w-full text-center text-[10px] text-slate-400 border-t pt-2 mt-8">
                        Generated by Hotel AI CMS • Page <span className="page-number"></span>
                    </div>
                </div>
            </div>
